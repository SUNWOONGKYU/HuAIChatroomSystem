...
test("리더 기획 요청은 재고가 아니다", () => {
  // payload.stage='leader_planning_requested' 는 proposalId 가 없고 협업 운영센터도 안 보여준다.
...
test("취소 기록은 협업 운영센터가 미결을 가리는 조건과 같은 stage 로 들어간다", () => {
  // 협업 운영센터는 stage='task_approval' 만 보고 미결 여부를 판정한다
