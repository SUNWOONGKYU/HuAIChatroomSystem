...
- `2026_08_11__HuAI_System_관계도.svg` — **2026-08-11 기준. 오늘 구조가 빠져 있다**
- `2026_08_11__HuAI_System_작업흐름도.svg` — 위와 같음
  (두 SVG 는 3엔진 인계·포럼 주제 분리·결과물 배포/파일 전달·전문 보기·방 기억·야간 보관을
   담고 있지 않다. 다시 그리기 전까지는 아래 md 두 개가 최신이다.)
